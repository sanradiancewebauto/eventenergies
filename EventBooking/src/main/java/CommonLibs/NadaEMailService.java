...
public class NadaEMailService {
	...
	public String getInbox(String mailID) throws JSONException, UnirestException, JsonParseException, JsonMappingException, IOException {
    		...
    		while(i < jsonResponseMsgs.length()) {
                ...
                if ((messageDetails.get("fe").equals("admin@eventenergies.com")) && 
                	...
                	if (regConfirmStatus.equals("OK")) {
                		...
                		log.info("Registered user email verification failed.");
                		msgStatus = false;
                		break;
                	}
